...
function(e, t) {
	...
	function i(e, n, r, i) {
		if (se.acceptData(e)) {
			var o, a, s = se.expando,
				...
				c = l ? se.cache : e,
				f = l ? e[s] : e[s] && s;
			if (f && c[f] && (i || c[f].data) || !u || r !== t) return f || (l ? e[s] = f = Z.pop() || se.guid++ : f = s), c[f] || (c[f] = {}, l || (c[f].toJSON = se.noop)), "object" != typeof n && "function" != typeof n || (i ? c[f] = se.extend(c[f], n) : c[f].data = se.extend(c[f].data, n)), o = c[f], i || (o.data || (o.data = {}), o = o.data), r !== t && (o[se.camelCase(n)] = r), u ? null == (a = o[n]) && (a = o[se.camelCase(n)]) : a = o, a
		}
	}
	function o(e, t, n) {
		if (se.acceptData(e)) {
	...
	function y(e, t) {
		if (1 === t.nodeType && se.hasData(e)) {
			...
			if (s) {
				...
				for (n in s) for (r = 0, i = s[n].length; r < i; r++) se.event.add(t, n, s[n][r])
			}
	...
	function w(e, t) {
		if (t in e) return t;
		for (var n = t.charAt(0).toUpperCase() + t.slice(1), r = t, i = Nt.length; i--;) if ((t = Nt[i] + n) in e) return t;
		return r
	}
	function T(e, t) {
	...
	function N(e, t) {
		for (var n, r, i, o = [], a = 0, s = e.length; a < s; a++) r = e[a], r.style && (o[a] = se._data(r, "olddisplay"), n = r.style.display, t ? (o[a] || "none" !== n || (r.style.display = ""), "" === r.style.display && T(r) && (o[a] = se._data(r, "olddisplay", S(r.nodeName)))) : o[a] || (i = T(r), (n && "none" !== n || !i) && se._data(r, "olddisplay", i ? n : se.css(r, "display"))));
	...
	function k(e, t, n, r, i) {
		for (var o = n === (r ? "border" : "content") ? 4 : "width" === t ? 1 : 0, a = 0; o < 4; o += 2)"margin" === n && (a += se.css(e, n + Tt[o], !0, i)), r ? ("content" === n && (a -= se.css(e, "padding" + Tt[o], !0, i)), "margin" !== n && (a -= se.css(e, "border" + Tt[o] + "Width", !0, i))) : (a += se.css(e, "padding" + Tt[o], !0, i), "padding" !== n && (a += se.css(e, "border" + Tt[o] + "Width", !0, i)));
		return a
	}
	function E(e, t, n) {
		var r = !0,
		...
		if (i <= 0 || null == i) {
			if (i = ct(e, t, o), (i < 0 || null == i) && (i = e.style[t]), yt.test(i)) return i;
	...
	function S(e) {
		var t = Y,
			n = bt[e];
		return n || (n = A(e, t), "none" !== n && n || (ut = (ut || se("<iframe frameborder='0' width='0' height='0'/>").css("cssText", "display:block !important")).appendTo(t.documentElement), t = (ut[0].contentWindow || ut[0].contentDocument).document, t.write("<!doctype html><html><body>"), t.close(), n = A(e, t), ut.detach()), bt[e] = n), n
	}
	function A(e, t) {
	...
	function B(e, t) {
		se.each(t, function(t, n) {
			for (var r = (nn[t] || []).concat(nn["*"]), i = 0, o = r.length; i < o; i++) if (r[i].call(e, t, n)) return
		})
	}
	function P(e, t, n) {
		var r, i, o = 0,
			...
			u = function() {
				if (i) return !1;
				for (var t = Gt || O(), n = Math.max(0, l.startTime + l.duration - t), r = n / l.duration || 0, o = 1 - r, a = 0, u = l.tweens.length; a < u; a++) l.tweens[a].run(o);
			...
			c = l.props;
		for (R(c, l.opts.specialEasing); o < a; o++) if (r = tn[o].call(l, e, c, l.opts)) return r;
	...
	function W(e, t, n) {
		...
		for (i in t) if (a = t[i], Kt.exec(a)) {
			if (delete t[i], u = u || "toggle" === a, a === (m ? "hide" : "show")) continue;
			g.push(i)
		}
		if (o = g.length) {
			s = se._data(e, "fxshow") || se._data(e, "fxshow", {}), "hidden" in s && (m = s.hidden), u && (s.hidden = !m), m ? se(e).show() : p.done(function() {
				se(e).hide()
			}), p.done(function() {
				var t;
			...
			for (i = 0; i < o; i++) r = g[i], l = p.createTween(r, m ? s[r] : 0), h[r] = s[r] || se.style(e, r), r in s || (s[r] = l.start, m && (l.end = l.start, l.start = "width" === r || "height" === r ? 1 : 0))
		}
	}
	function $(e, t, n, r, i) {
	...
	var X, U, V = typeof t,
		...
		xe = function(e) {
			(Y.addEventListener || "load" === e.type || "complete" === Y.readyState) && (we(), se.ready())
		},
		we = function() {
	...
	se.fn = se.prototype = {
		...
		init: function(e, n, r) {
			...
			if ("string" == typeof e) {
				...
				if (i[1]) {
					if (n = n instanceof se ? n[0] : n, se.merge(this, se.parseHTML(i[1], n && n.nodeType ? n.ownerDocument || n : Y, !0)), pe.test(i[1]) && se.isPlainObject(n)) for (i in n) se.isFunction(this[i]) ? this[i](n[i]) : this.attr(i, n[i]);
					return this
				}
		...
		var e, n, r, i, o, a, s = arguments[0] || {},
			...
			l = arguments.length,
			c = !1;
		for ("boolean" == typeof s && (c = s, s = arguments[1] || {}, u = 2), "object" == typeof s || se.isFunction(s) || (s = {}), l === u && (s = this, --u); u < l; u++) if (null != (o = arguments[u])) for (i in o) e = s[i], r = o[i], s !== r && (c && r && (se.isPlainObject(r) || (n = se.isArray(r))) ? (n ? (n = !1, a = e && se.isArray(e) ? e : []) : a = e && se.isPlainObject(e) ? e : {}, s[i] = se.extend(c, a, r)) : r !== t && (s[i] = r));
		return s
	}, se.extend({
		noConflict: function(t) {
			return e.$ === se && (e.$ = Q), t && e.jQuery === se && (e.jQuery = G), se
		},
		isReady: !1,
		readyWait: 1,
		...
		ready: function(e) {
			if (!0 === e ? !--se.readyWait : !se.isReady) {
				if (!Y.body) return setTimeout(se.ready);
				se.isReady = !0, !0 !== e && --se.readyWait > 0 || (X.resolveWith(Y, [se]), se.fn.trigger && se(Y).trigger("ready").off("ready"))
			}
		},
		...
		if (!X) if (X = se.Deferred(), "complete" === Y.readyState) setTimeout(se.ready);
	...
	se.Callbacks = function(e) {
			...
			p = {
				...
				remove: function() {
					return l && se.each(arguments, function(e, t) {
						for (var r;
						(r = se.inArray(t, l, r)) > -1;) l.splice(r, 1), n && (r <= a && a--, r <= s && s--)
					}), this
				},
				has: function(e) {
		...
		when: function(e) {
			...
			if (a > 1) for (t = new Array(a), n = new Array(a), r = new Array(a); i < a; i++) o[i] && se.isFunction(o[i].promise) ? o[i].promise().done(l(i, r, o)).fail(u.reject).progress(l(i, n, t)) : --s;
	...
	se.extend({
		...
		data: function(e, n) {
			...
			if (e === t) {
				if (this.length && (u = se.data(o), 1 === o.nodeType && !se._data(o, "parsedAttrs"))) {
					for (r = o.attributes; s < r.length; s++) i = r[s].name, i.indexOf("data-") || (i = se.camelCase(i.slice(5)), a(o, i, u[i]));
			...
			return "object" == typeof e ? this.each(function() {
				...
				if (n === t) return o ? a(o, e, se.data(o, e)) : null;
				this.each(function() {
					se.data(this, e, n)
				})
		...
		queue: function(e, t, n) {
			var r;
			if (e) return t = (t || "fx") + "queue", r = se._data(e, t), n && (!r || se.isArray(n) ? r = se._data(e, t, se.makeArray(n)) : r.push(n)), r || []
		},
		...
		queue: function(e, n) {
			var r = 2;
			return "string" != typeof e && (n = e, e = "fx", r--), arguments.length < r ? se.queue(this[0], e) : n === t ? this : this.each(function() {
	...
	se.fn.extend({
		...
		addClass: function(e) {
			...
			if (u) for (t = (e || "").match(le) || []; a < s; a++) if (n = this[a], r = 1 === n.nodeType && (n.className ? (" " + n.className + " ").replace(Se, " ") : " ")) {
		...
		toggleClass: function(e, t) {
			...
			return se.isFunction(e) ? this.each(function(n) {
				...
				if ("string" === n) for (var i, o = 0, a = se(this), s = t, u = e.match(le) || []; i = u[o++];) s = r ? s : !a.hasClass(i), a[s ? "addClass" : "removeClass"](i);
				else n !== V && "boolean" !== n || (this.className && se._data(this, "__className__", this.className), this.className = this.className || !1 === e ? "" : se._data(this, "__className__") || "")
			})
		},
		hasClass: function(e) {
			for (var t = " " + e + " ", n = 0, r = this.length; n < r; n++) if (1 === this[n].nodeType && (" " + this[n].className + " ").replace(Se, " ").indexOf(t) >= 0) return !0;
			return !1
		},
		val: function(e) {
			var n, r, i, o = this[0]; {
				if (arguments.length) return i = se.isFunction(e), this.each(function(n) {
					var o, a = se(this);
					1 === this.nodeType && (o = i ? e.call(this, n, a.val()) : e, null == o ? o = "" : "number" == typeof o ? o += "" : se.isArray(o) && (o = se.map(o, function(e) {
						return null == e ? "" : e + ""
					})), (r = se.valHooks[this.type] || se.valHooks[this.nodeName.toLowerCase()]) && "set" in r && r.set(this, o, "value") !== t || (this.value = o))
				});
				if (o) return (r = se.valHooks[o.type] || se.valHooks[o.nodeName.toLowerCase()]) && "get" in r && (n = r.get(o, "value")) !== t ? n : (n = o.value, "string" == typeof n ? n.replace(Ae, "") : null == n ? "" : n)
			}
		}
	}), se.extend({
		valHooks: {
			...
			select: {
				get: function(e) {
					for (var t, n, r = e.options, i = e.selectedIndex, o = "select-one" === e.type || i < 0, a = o ? null : [], s = o ? i + 1 : r.length, u = i < 0 ? s : o ? i : 0; u < s; u++) if (n = r[u], (n.selected || u === i) && (se.support.optDisabled ? !n.disabled : null === n.getAttribute("disabled")) && (!n.parentNode.disabled || !se.nodeName(n.parentNode, "optgroup"))) {
		...
		attr: function(e, n, r) {
			...
			if (e && 3 !== s && 8 !== s && 2 !== s) return typeof e.getAttribute === V ? se.prop(e, n, r) : (o = 1 !== s || !se.isXMLDoc(e), o && (n = n.toLowerCase(), i = se.attrHooks[n] || (Le.test(n) ? Ee : ke)), r === t ? i && o && "get" in i && null !== (a = i.get(e, n)) ? a : (typeof e.getAttribute !== V && (a = e.getAttribute(n)), null == a ? t : a) : null !== r ? i && o && "set" in i && (a = i.set(e, r, n)) !== t ? a : (e.setAttribute(n, r + ""), r) : void se.removeAttr(e, n))
		},
		...
		prop: function(e, n, r) {
			var i, o, a, s = e.nodeType;
			if (e && 3 !== s && 8 !== s && 2 !== s) return a = 1 !== s || !se.isXMLDoc(e), a && (n = se.propFix[n] || n, o = se.propHooks[n]), r !== t ? o && "set" in o && (i = o.set(e, r, n)) !== t ? i : e[n] = r : o && "get" in o && null !== (i = o.get(e, n)) ? i : e[n]
		},
		propHooks: {
			tabIndex: {
				get: function(e) {
		...
		set: function(e, t, n) {
			if (!se.nodeName(e, "input")) return ke && ke.set(e, t, n);
			e.defaultValue = t
		}
	...
	se.event = {
		...
		add: function(e, n, r, i, o) {
			...
			if (y) {
				...
				}, f.elem = e), n = (n || "").match(le) || [""], u = n.length; u--;) a = Pe.exec(n[u]) || [], h = m = a[1], g = (a[2] || "").split(".").sort(), c = se.event.special[h] || {}, h = (o ? c.delegateType : c.bindType) || h, c = se.event.special[h] || {}, p = se.extend({
					type: h,
					origType: m,
					data: i,
					handler: r,
		...
		remove: function(e, t, n, r, i) {
			...
			if (m && (c = m.events)) {
				for (t = (t || "").match(le) || [""], l = t.length; l--;) if (s = Pe.exec(t[l]) || [], d = g = s[1], h = (s[2] || "").split(".").sort(), d) {
					for (f = se.event.special[d] || {}, d = (r ? f.delegateType : f.bindType) || d, p = c[d] || [], s = s[2] && new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)"), u = o = p.length; o--;) a = p[o], !i && g !== a.origType || n && n.guid !== a.guid || s && !s.test(a.namespace) || r && r !== a.selector && ("**" !== r || !a.selector) || (p.splice(o, 1), a.selector && p.delegateCount--, f.remove && f.remove.call(e, a));
		...
		trigger: function(n, r, i, o) {
			...
			if (u = f = i = i || Y, 3 !== i.nodeType && 8 !== i.nodeType && !Be.test(h + se.event.triggered) && (h.indexOf(".") >= 0 && (g = h.split("."), h = g.shift(), g.sort()), s = h.indexOf(":") < 0 && "on" + h, n = n[se.expando] ? n : new se.Event(h, "object" == typeof n && n), n.isTrigger = !0, n.namespace = g.join("."), n.namespace_re = n.namespace ? new RegExp("(^|\\.)" + g.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, n.result = t, n.target || (n.target = i), r = null == r ? [n] : se.makeArray(r, [n]), c = se.event.special[h] || {}, o || !c.trigger || !1 !== c.trigger.apply(i, r))) {
				...
				for (p = 0;
				(u = d[p++]) && !n.isPropagationStopped();) n.type = p > 1 ? l : c.bindType || h, a = (se._data(u, "events") || {})[n.type] && se._data(u, "handle"), a && a.apply(u, r), (a = s && u[s]) && se.acceptData(u) && a.apply && !1 === a.apply(u, r) && n.preventDefault();
				if (n.type = h, !o && !n.isDefaultPrevented() && (!c._default || !1 === c._default.apply(i.ownerDocument, r)) && ("click" !== h || !se.nodeName(i, "a")) && se.acceptData(i) && s && i[h] && !se.isWindow(i)) {
					f = i[s], f && (i[s] = null), se.event.triggered = h;
					try {
						i[h]()
					} catch (e) {}
		...
		dispatch: function(e) {
			...
			if (u[0] = e, e.delegateTarget = this, !c.preDispatch || !1 !== c.preDispatch.call(this, e)) {
				for (s = se.event.handlers.call(this, e, l), n = 0;
				(o = s[n++]) && !e.isPropagationStopped();) for (e.currentTarget = o.elem, a = 0;
				(i = o.handlers[a++]) && !e.isImmediatePropagationStopped();) e.namespace_re && !e.namespace_re.test(i.namespace) || (e.handleObj = i, e.data = i.data, (r = ((se.event.special[i.origType] || {}).handle || i.handler).apply(o.elem, u)) !== t && !1 === (e.result = r) && (e.preventDefault(), e.stopPropagation()));
		...
		handlers: function(e, n) {
			...
			if (u && l.nodeType && (!e.button || "click" !== e.type)) for (; l != this; l = l.parentNode || this) if (1 === l.nodeType && (!0 !== l.disabled || "click" !== e.type)) {
				for (o = [], a = 0; a < u; a++) i = n[a], r = i.selector + " ", o[r] === t && (o[r] = i.needsContext ? se(r, this).index(l) >= 0 : se.find(r, this, null, [l]).length), o[r] && o.push(i);
				o.length && s.push({
					elem: l,
					handlers: o
				})
		...
		special: {
			...
			click: {
				trigger: function() {
					if (se.nodeName(this, "input") && "checkbox" === this.type && this.click) return this.click(), !1
				}
			},
			focus: {
				trigger: function() {
	...
	}, se.removeEvent = Y.removeEventListener ?
	function(e, t, n) {
		...
		e && e.type ? (this.originalEvent = e, this.type = e.type, this.isDefaultPrevented = e.defaultPrevented || !1 === e.returnValue || e.getPreventDefault && e.getPreventDefault() ? u : l) : this.type = e, t && se.extend(this, t), this.timeStamp = e && e.timeStamp || se.now(), this[se.expando] = !0
	}, se.Event.prototype = {
		...
		setup: function() {
			if (_e.test(this.nodeName)) return "checkbox" !== this.type && "radio" !== this.type || (se.event.add(this, "propertychange._change", function(e) {
			...
			var n = 0,
				...
				s = function(i, s, u, l, c) {
					...
					if (m += y, r && y !== m) {
						...
						if (i) {
							if (m > 0) for (; y--;) v[y] || g[y] || (g[y] = V.call(l));
							g = d(g)
						}
		...
		function v(e, t, n, r) {
			...
			if (!r && 1 === f.length) {
				...
				for (i = ue.needsContext.test(e) ? 0 : o.length; i-- && (a = o[i], !T.relative[s = a.type]);) if ((u = T.find[s]) && (r = u(a.matches[0].replace(me, ye), le.test(o[0].type) && t.parentNode || t))) {
		...
		C = a.isXML = function(e) {
			...
			}), H = new RegExp(H.join("|")), q = new RegExp(q.join("|")), _ = n(D.contains) || D.compareDocumentPosition ?
			function(e, t) {
			...
			pseudos: {
				...
				lang: i(function(e) {
					return ae.test(e || "") || a.error("unsupported lang: " + e), e = e.replace(me, ye).toLowerCase(), function(t) {
						var n;
						do {
		...
		k = a.compile = function(e, t) {
			...
			return o
		}, T.pseudos.nth = T.pseudos.eq, T.filters = b.prototype = T.pseudos, T.setFilters = new b, A(), a.attr = se.attr, se.find = a, se.expr = a.selectors, se.expr[":"] = se.expr.pseudos, se.unique = a.uniqueSort, se.text = a.getText, se.isXMLDoc = a.isXML, se.contains = a.contains
	}(e);
	var Re = /Until$/,
	...
	se.fn.extend({
		find: function(e) {
			...
			for (n = [], t = 0; t < i; t++) se.find(e, this[t], n);
		...
		has: function(e) {
			...
			return this.filter(function() {
				for (t = 0; t < r; t++) if (se.contains(this, n[t])) return !0
			})
		},
		not: function(e) {
		...
		closest: function(e, t) {
			for (var n, r = 0, i = this.length, o = [], a = Ie.test(e) || "string" != typeof e ? se(e, t || this.context) : 0; r < i; r++) for (n = this[r]; n && n.ownerDocument && n !== t && 11 !== n.nodeType;) {
	...
	ot.optgroup = ot.option, ot.tbody = ot.tfoot = ot.colgroup = ot.caption = ot.thead, ot.th = ot.td, se.fn.extend({
		...
		html: function(e) {
			return se.access(this, function(e) {
				...
				if ("string" == typeof e && !Ze.test(e) && (se.support.htmlSerialize || !Ve.test(e)) && (se.support.leadingWhitespace || !Ye.test(e)) && !ot[(Ge.exec(e) || ["", ""])[1].toLowerCase()]) {
					e = e.replace(Je, "<$1></$2>");
					try {
						for (; r < i; r++) n = this[r] || {}, 1 === n.nodeType && (se.cleanData(b(n, !1)), n.innerHTML = e);
						n = 0
					} catch (e) {}
				}
		...
		domManip: function(e, n, r) {
			...
			var i, o, a, s, u, l, c = 0,
				...
				y = e[0],
				v = se.isFunction(y);
			if (v || !(f <= 1 || "string" != typeof y || se.support.checkClone) && tt.test(y)) return this.each(function(i) {
				var o = p.eq(i);
				v && (e[0] = y.call(this, i, n ? o.html() : t)), o.domManip(e, n, r)
			});
			if (f && (l = se.buildFragment(e, this[0].ownerDocument, !1, this), i = l.firstChild, 1 === l.childNodes.length && (l = i), i)) {
				for (n = n && se.nodeName(i, "tr"), s = se.map(b(l, "script"), h), a = s.length; c < f; c++) o = l, c !== m && (o = se.clone(o, !0, !0), a && se.merge(s, b(o, "script"))), r.call(n && se.nodeName(this[c], "table") ? d(this[c], "tbody") : this[c], o, c);
				if (a) for (u = s[s.length - 1].ownerDocument, se.map(s, g), c = 0; c < a; c++) o = s[c], nt.test(o.type || "") && !se._data(o, "globalEval") && se.contains(u, o) && (o.src ? se.ajax({
					url: o.src,
					type: "GET",
					dataType: "script",
					async: !1,
		...
		se.fn[e] = function(e) {
			for (var n, r = 0, i = [], o = se(e), a = o.length - 1; r <= a; r++) n = r === a ? this : this.clone(!0), se(o[r])[t](n), te.apply(i, n.get());
			return this.pushStack(i)
		}
	}), se.extend({
		clone: function(e, t, n) {
			var r, i, o, a, s, u = se.contains(e.ownerDocument, e);
			if (se.support.html5Clone || se.isXMLDoc(e) || !Ve.test("<" + e.nodeName + ">") ? o = e.cloneNode(!0) : (st.innerHTML = e.outerHTML, st.removeChild(o = st.firstChild)), !(se.support.noCloneEvent && se.support.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || se.isXMLDoc(e))) for (r = b(o), s = b(e), a = 0; null != (i = s[a]); ++a) r[a] && v(i, r[a]);
			if (t) if (n) for (s = s || b(e), r = r || b(o), a = 0; null != (i = s[a]); a++) y(i, r[a]);
			else y(e, o);
			return r = b(o, "script"), r.length > 0 && m(r, !u && b(e, "script")), r = s = i = null, o
		},
		buildFragment: function(e, t, n, r) {
			for (var i, o, a, s, u, l, c, f = e.length, d = p(t), h = [], g = 0; g < f; g++) if ((o = e[g]) || 0 === o) if ("object" === se.type(o)) se.merge(h, o.nodeType ? [o] : o);
			else if (Ke.test(o)) {
				...
				if (!se.support.leadingWhitespace && Ye.test(o) && h.push(t.createTextNode(Ye.exec(o)[0])), !se.support.tbody) for (o = "table" !== u || Qe.test(o) ? "<table>" !== c[1] || Qe.test(o) ? 0 : s : s.firstChild, i = o && o.childNodes.length; i--;) se.nodeName(l = o.childNodes[i], "tbody") && !l.childNodes.length && o.removeChild(l);
	...
	se.fn.extend({
		css: function(e, n) {
			return se.access(this, function(e, n, r) {
				var i, o, a = {},
					s = 0;
				if (se.isArray(n)) {
					for (o = lt(e), i = n.length; s < i; s++) a[n[s]] = se.css(e, n[s], !1, o);
					return a
				}
		...
		style: function(e, n, r, i) {
			if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
				...
				if (!(a = typeof r, "string" === a && (o = vt.exec(r)) && (r = (o[1] + 1) * o[2] + parseFloat(se.css(e, n)), a = "number"), null == r || "number" === a && isNaN(r) || ("number" !== a || se.cssNumber[u] || (r += "px"), se.support.clearCloneStyle || "" !== r || 0 !== n.indexOf("background") || (l[n] = "inherit"), s && "set" in s && (r = s.set(e, r, i)) === t))) try {
					l[n] = r
				} catch (e) {}
			}
		},
		css: function(e, n, r, i) {
			var o, a, s, u = se.camelCase(n);
			return n = se.cssProps[u] || (se.cssProps[u] = w(e.style, u)), s = se.cssHooks[n] || se.cssHooks[u], s && "get" in s && (a = s.get(e, !0, r)), a === t && (a = ct(e, n, i)), "normal" === a && n in wt && (a = wt[n]), "" === r || r ? (o = parseFloat(a), !0 === r || se.isNumeric(o) ? o || 0 : a) : a
		},
		...
		var i, o, a, s = r || lt(e),
			...
			l = e.style;
		return s && ("" !== u || se.contains(e.ownerDocument, e) || (u = se.style(e, n)), yt.test(u) && gt.test(n) && (i = l.width, o = l.minWidth, a = l.maxWidth, l.minWidth = l.maxWidth = l.width = u, u = s.width, l.width = i, l.minWidth = o, l.maxWidth = a)), u
		...
		var i, o, a, s = r || lt(e),
			u = s ? s[n] : t,
			l = e.style;
		return null == u && l && l[n] && (u = l[n]), yt.test(u) && !dt.test(n) && (i = l.left, o = e.runtimeStyle, a = o && o.left, a && (o.left = e.currentStyle.left), l.left = "fontSize" === n ? "1em" : u, u = l.pixelLeft + "px", l.left = i, a && (o.left = a)), "" === u ? "auto" : u
	}), se.each(["height", "width"], function(e, t) {
		se.cssHooks[t] = {
			get: function(e, n, r) {
				if (n) return 0 === e.offsetWidth && ht.test(se.css(e, "display")) ? se.swap(e, xt, function() {
					return E(e, t, r)
				}) : E(e, t, r)
			},
			set: function(e, n, r) {
		...
		set: function(e, t) {
			...
			n.zoom = 1, (t >= 1 || "" === t) && "" === se.trim(o.replace(ft, "")) && n.removeAttribute && (n.removeAttribute("filter"), "" === t || r && !r.filter) || (n.filter = ft.test(o) ? o.replace(ft, i) : o + " " + i)
		}
	}), se(function() {
		se.support.reliableMarginRight || (se.cssHooks.marginRight = {
			get: function(e, t) {
				if (t) return se.swap(e, {
			...
			se.cssHooks[t] = {
				get: function(e, n) {
					if (n) return n = ct(e, t), yt.test(n) ? se(e).position()[t] + "px" : n
				}
			}
		})
	...
	jt = Pt.exec(Dt.toLowerCase()) || [], se.fn.load = function(e, n, r) {
		...
		ajax: function(e, n) {
			function r(e, n, r, i) {
				var o, f, v, b, w, N = n;
				2 !== x && (x = 2, u && clearTimeout(u), c = t, s = i || "", T.readyState = e > 0 ? 4 : 0, r && (b = q(p, T, r)), e >= 200 && e < 300 || 304 === e ? (p.ifModified && (w = T.getResponseHeader("Last-Modified"), w && (se.lastModified[a] = w), (w = T.getResponseHeader("etag")) && (se.etag[a] = w)), 204 === e ? (o = !0, N = "nocontent") : 304 === e ? (o = !0, N = "notmodified") : (o = M(p, b), N = o.state, f = o.data, v = o.error, o = !v)) : (v = N, !e && N || (N = "error", e < 0 && (e = 0))), T.status = e, T.statusText = (n || N) + "", o ? g.resolveWith(d, [f, N, T]) : g.rejectWith(d, [T, N, v]), T.statusCode(y), y = t, l && h.trigger(o ? "ajaxSuccess" : "ajaxError", [T, p, o ? f : v]), m.fireWith(d, [T, N]), l && (h.trigger("ajaxComplete", [T, p]), --se.active || se.event.trigger("ajaxStop")))
			}
			"object" == typeof e && (n = e, e = t), n = n || {};
			var i, o, a, s, u, l, c, f, p = se.ajaxSetup({}, n),
				d = p.context || p,
			...
			if (g.promise(T).complete = m.add, T.success = T.done, T.error = T.fail, p.url = ((e || p.url || Dt) + "").replace(qt, "").replace(Bt, jt[1] + "//"), p.type = n.method || n.type || p.method || p.type, p.dataTypes = se.trim(p.dataType || "*").toLowerCase().match(le) || [""], null == p.crossDomain && (i = Pt.exec(p.url.toLowerCase()), p.crossDomain = !(!i || i[1] === jt[1] && i[2] === jt[2] && (i[3] || ("http:" === i[1] ? 80 : 443)) == (jt[3] || ("http:" === jt[1] ? 80 : 443)))), p.data && p.processData && "string" != typeof p.data && (p.data = se.param(p.data, p.traditional)), L(Wt, p, n, T), 2 === x) return T;
			l = p.global, l && 0 == se.active++ && se.event.trigger("ajaxStart"), p.type = p.type.toUpperCase(), p.hasContent = !Ot.test(p.type), a = p.url, p.hasContent || (p.data && (a = p.url += (Ht.test(a) ? "&" : "?") + p.data, delete p.data), !1 === p.cache && (p.url = Mt.test(a) ? a.replace(Mt, "$1_=" + Lt++) : a + (Ht.test(a) ? "&" : "?") + "_=" + Lt++)), p.ifModified && (se.lastModified[a] && T.setRequestHeader("If-Modified-Since", se.lastModified[a]), se.etag[a] && T.setRequestHeader("If-None-Match", se.etag[a])), (p.data && p.hasContent && !1 !== p.contentType || n.contentType) && T.setRequestHeader("Content-Type", p.contentType), T.setRequestHeader("Accept", p.dataTypes[0] && p.accepts[p.dataTypes[0]] ? p.accepts[p.dataTypes[0]] + ("*" !== p.dataTypes[0] ? ", " + It + "; q=0.01" : "") : p.accepts["*"]);
	...
	se.ajaxSetup({
		...
		if (u || "jsonp" === n.dataTypes[0]) return o = n.jsonpCallback = se.isFunction(n.jsonpCallback) ? n.jsonpCallback() : n.jsonpCallback, u ? n[u] = n[u].replace(Xt, "$1" + o) : !1 !== n.jsonp && (n.url += (Ht.test(n.url) ? "&" : "?") + n.jsonp + "=" + o), n.converters["script json"] = function() {
			return s || se.error(o + " was not called"), s[0]
		}, n.dataTypes[0] = "json", a = e[o], e[o] = function() {
			s = arguments
		}, i.always(function() {
			e[o] = a, n[o] && (n.jsonpCallback = r.jsonpCallback, zt.push(o)), s && se.isFunction(a) && a(s[0]), s = a = t
		}), "script"
	});
	var Ut, Vt, Yt = 0,
		Jt = e.ActiveXObject &&
	...
	} : _, Vt = se.ajaxSettings.xhr(), se.support.cors = !! Vt && "withCredentials" in Vt, (Vt = se.support.ajax = !! Vt) && se.ajaxTransport(function(n) {
			...
			return {
				send: function(i, o) {
					...
					u.send(n.hasContent && n.data || null), r = function(e, i) {
						...
						f && o(s, c, f, l)
					}, n.async ? 4 === u.readyState ? setTimeout(r) : (a = ++Yt, Jt && (Ut || (Ut = {}, se(e).unload(Jt)), Ut[a] = r), u.onreadystatechange = r) : r()
				},
				abort: function() {
					r && r(t, !0)
				}
	...
	se.Animation = se.extend(P, {
		tweener: function(e, t) {
			...
			for (var n, r = 0, i = e.length; r < i; r++) n = e[r], nn[n] = nn[n] || [], nn[n].unshift(t)
		},
		...
		run: function(e) {
			...
			return this.options.duration ? this.pos = t = se.easing[this.easing](e, this.options.duration * e, 0, 1, this.options.duration) : this.pos = t = e, this.now = (this.end - this.start) * t + this.start, this.options.step && this.options.step.call(this.elem, this.now, this), n && n.set ? n.set(this) : $.propHooks._default.set(this), this
		}
	...
	}, se.timers = [], se.fx = $.prototype.init, se.fx.tick = function() {
		var e, n = se.timers,
			r = 0;
		for (Gt = se.now(); r < n.length; r++)(e = n[r])() || n[r] !== e || n.splice(r--, 1);
		n.length || se.fx.stop(), Gt = t
		...
		var n, r, i = {
			...
			o = this[0],
			a = o && o.ownerDocument;
		if (a) return n = a.documentElement, se.contains(n, o) ? (typeof o.getBoundingClientRect !== V && (i = o.getBoundingClientRect()), r = z(a), {
		...
		setOffset: function(e, t, n) {
			...
			var i, o, a = se(e),
				...
				f = {},
				p = {};
			c ? (p = a.position(), i = p.top, o = p.left) : (i = parseFloat(u) || 0, o = parseFloat(l) || 0), se.isFunction(t) && (t = t.call(e, n, s)), null != t.top && (f.top = t.top - s.top + i), null != t.left && (f.left = t.left - s.left + o), "using" in t ? t.using.call(e, f) : a.css(f)
		}
	}, se.fn.extend({
		position: function() {
			if (this[0]) {
		...
		offsetParent: function() {
			return this.map(function() {
				for (var e = this.offsetParent || Y.documentElement; e && !se.nodeName(e, "html") && "static" === se.css(e, "position");) e = e.offsetParent;
...
function disabledDevelopmentTools() {
  let newElement = document.createElement("div");
  Object.defineProperty(newElement, "id", {
    get: () => {
