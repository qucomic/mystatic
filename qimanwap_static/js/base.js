...
function shujia2(t){
	...
	tips.innerHTML = '瀹告彃濮為崗銉ゅ姛閺嬶拷';
	document.body.appendChild(tips);
	setTimeout(function(){tips.style.display="none"},2000);
}

function showlogin2(t){	//閺屻儳婀呴弰顖氭儊閻ц缍�
...
function gao(){
	var xmlhttp = new XMLHttpRequest();//閸忣剙鎲�
...
function show_search(){
	...
	type.innerHTML == "娑旓箑鎮�"?type.innerHTML = "娴ｆ粏鈧拷":type.innerHTML = "娑旓箑鎮�";
